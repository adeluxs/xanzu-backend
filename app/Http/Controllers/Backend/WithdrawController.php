...
class WithdrawController extends Controller
{
    ...
    public function methodStore(Request $request)
    {
        ...
        return to_route('admin.withdraw.method.list', $input['type']);
    }
    ...
    public function methodUpdate(Request $request, $id)
    {
        ...
        return to_route('admin.withdraw.method.list', $withdrawMethod->type);
    }
    ...
    public function actionNow(Request $request)
    {
        ...
        if (isset($input['approve'])) {
            ...
            Txn::update($transaction->tnx, TxnStatus::Cancelled, $transaction->user_id, $approvalCause);
        ...
        $this->sendNotify(
            ...
            $user->phone,
            $user->id,
            frontendPanelUrl('transactions', ['type' => $transaction->type?->value ?? 'withdraw_all'], false)
        );
