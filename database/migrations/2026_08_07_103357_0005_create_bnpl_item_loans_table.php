...
return new class extends Migration
{
  ...
  `updated_at` timestamp NULL DEFAULT NULL
            ...
            DB::statement('ALTER TABLE `bnpl_item_loans` ADD PRIMARY KEY (`id`),
ADD KEY `bnpl_item_loans_user_id_index` (`user_id`),
ADD KEY `bnpl_item_loans_order_id_index` (`order_id`),
ADD KEY `bnpl_item_loans_order_item_id_index` (`order_item_id`)');
            DB::statement('ALTER TABLE `bnpl_item_loans` MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT');
