...
return new class extends Migration
{
  ...
  `updated_at` timestamp NULL DEFAULT NULL
            ...
            DB::statement('ALTER TABLE `credit_limit_splits` ADD PRIMARY KEY (`id`)');
            DB::statement('ALTER TABLE `credit_limit_splits` MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT');
