...
return new class extends Migration
{
  ...
  `updated_at` timestamp NULL DEFAULT NULL
            ...
            DB::statement('ALTER TABLE `cron_jobs` ADD PRIMARY KEY (`id`)');
            DB::statement('ALTER TABLE `cron_jobs` MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15');
