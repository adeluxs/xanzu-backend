...
return new class extends Migration
{
  ...
  `locale` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT \'en\'
            ...
            DB::statement('ALTER TABLE `landing_contents` ADD PRIMARY KEY (`id`)');
            DB::statement('ALTER TABLE `landing_contents` MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52');
