...
return new class extends Migration
{
  ...
  `shipping_charge_type` enum(\'fixed\',\'percentage\') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL
            ...
            DB::statement('ALTER TABLE `listings` ADD PRIMARY KEY (`id`),
ADD KEY `listings_provider_provider_product_id_idx` (`provider_id`,`provider_product_id`),
ADD KEY `listings_seller_id_index` (`seller_id`),
ADD KEY `listings_status_index` (`status`),
ADD KEY `listings_category_id_index` (`category_id`)');
            DB::statement('ALTER TABLE `listings` MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT');
