...
return new class extends Migration
{
  ...
  `translate` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
            ...
            DB::statement('ALTER TABLE `navigations` ADD PRIMARY KEY (`id`)');
            DB::statement('ALTER TABLE `navigations` MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8');
