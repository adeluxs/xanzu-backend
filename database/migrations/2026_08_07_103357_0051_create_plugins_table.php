...
return new class extends Migration
{
  ...
  `updated_at` timestamp NULL DEFAULT NULL
            ...
            DB::statement('ALTER TABLE `plugins` ADD PRIMARY KEY (`id`)');
            DB::statement('ALTER TABLE `plugins` MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19');
