...
return new class extends Migration
{
  ...
  `updated_at` timestamp NULL DEFAULT NULL
            ...
            DB::statement('ALTER TABLE `withdraw_methods` ADD PRIMARY KEY (`id`)');
            DB::statement('ALTER TABLE `withdraw_methods` MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT');
