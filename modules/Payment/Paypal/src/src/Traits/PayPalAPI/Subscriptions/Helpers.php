...
trait Helpers
{
     ...
     */
    public function addPlanTrialPricing(string $interval_type, int $interval_count, float $price = 0): PayPal
    {
     ...
     * @throws Throwable
     */
    public function addDailyPlan(string $name, string $description, float $price): PayPal
    {
     ...
     * @throws Throwable
     */
    public function addWeeklyPlan(string $name, string $description, float $price): PayPal
    {
        if (isset($this->billing_plan)) {
            return $this;
        }
     ...
     * @throws Throwable
     */
    public function addMonthlyPlan(string $name, string $description, float $price): PayPal
    {
        if (isset($this->billing_plan)) {
            return $this;
        }
     ...
     * @throws Throwable
     */
    public function addAnnualPlan(string $name, string $description, float $price): PayPal
    {
        if (isset($this->billing_plan)) {
            return $this;
        }
     ...
     * @throws Throwable
     */
    public function addCustomPlan(string $name, string $description, float $price, string $interval_unit, int $interval_count): PayPal
    {
