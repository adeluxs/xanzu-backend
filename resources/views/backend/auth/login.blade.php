    ...
    <div class="login">
        ...
        <div class="login-content">
            <div class="logo">
                ...
                @endphp
                <a href="{{ route('home') }}">
                    <img src="{{ asset(setting('site_logo_dark', 'global')) }}"
            ...
            <div class="auth-body">
                <form action="{{ route('admin.login') }}" method="post">
                    ...
                    <div class="single-box">
                        ...
                        <input type="email" name="email" class="box-input" value="" required />
                    </div>
                    <div class="single-box">
                        <label for="" class="box-label">{{ __('Password') }}</label>
                        <input type="password" name="password" class="box-input" value="" />
                    </div>
                    <div class="single-box">
