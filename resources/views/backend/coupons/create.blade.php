                        ...
                        <div class="site-card-body">
                            <form action="{{ route('admin.coupon.store') }}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xxl-4">
                                        <div class="site-input-groups">
                                            <label for="discount_type" class="box-input-label">{{ __('Discount') }} <span
                                                    class="text-danger">*</span></label>
                                            <div class="position-relative">
                                                ...
                                                <div class="prcntcurr">
                                                    <select name="discount_type" class="form-select">
                                                        ...
                                                        <option value="amount" @selected(old('discount_type') == 'amount')>$</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xxl-4">
                                        <div class="site-input-groups">
                                            <label for="max_use_limit" class="box-input-label">{{ __('Max Use Limit') }}
                                                <span class="text-danger">*</span></label>
                                            <input type="number" name="max_use_limit" class="box-input mb-0"
                                                value="{{ old('max_use_limit', 0) }}" />
                                        </div>
                                    </div>
                                    <div class="col-xxl-4">
                                        <div class="site-input-groups">
                                            <label for="total_used" class="box-input-label">{{ __('Total Used') }} <span
                                                    class="text-danger">*</span></label>
                                            <input type="number" name="total_used" class="box-input mb-0"
                                                value="{{ old('total_used', 0) }}" />
                                        </div>
                                    </div>
                                    <div class="col-xxl-4">
                                        <div class="site-input-groups">
                                            ...
                                            <select name="status" class="form-select">
                                                <option value="1" @selected(old('status') == '1')>{{ __('Active') }}
                                                </option>
                                                <option value="0" @selected(old('status') == '0')>{{ __('Inactive') }}
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-xxl-4">
                                        <div class="site-input-groups">
                                            <label class="box-input-label" for="">{{ __('Show in Home') }}</label>
                                            <div class="switch-field same-type">
                                                <input type="radio" id="radio-home-yes" name="is_home" value="1"
                                                    @checked(old('is_home') == '1')>
                                                <label for="radio-home-yes">{{ __('Yes') }}</label>
                                                <input type="radio" id="radio-home-no" name="is_home" value="0"
                                                    @checked(old('is_home', '0') == '0')>
                                                <label for="radio-home-no">{{ __('No') }}</label>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- admin_approval removed -->
                                </div>
