...
@section('title', 'Create Courier Partner')
@section('content')
                ...
                <div class="row">
                    <div class="col">
                        <div class="title-content">
                            <h2 class="title">{{ __('Create Courier Partner') }}</h2>
                                ...
                                <div class="row">
                                    <div class="col-xxl-12">
                                        <div class="site-input-groups">
                                            ...
                                            <input type="text" name="name" class="box-input mb-0"
                                                value="{{ old('name') }}" placeholder="{{ __('e.g. DHL, FedEx, UPS') }}"
                                                required />
                                        </div>
                                    </div>
                                    <div class="col-xxl-6">
                                            ...
                                            <div class="wrap-custom-file">
                                                ...
                                                <label for="logo">
                                                    <img class="upload-icon"
                                                        ...
                                                        alt="">
                                                    <span>{{ __('Select Courier Logo') }}</span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xxl-12 mt-3">
                                        <div class="site-input-groups">
                                            ...
                                            <textarea name="admin_note" class="box-input mb-0" rows="4">{{ old('admin_note') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="action-btns mt-3">
                                    <button type="submit" class="site-btn-sm primary-btn me-2"><i data-lucide="check"></i>
                                        {{ __('Create Courier Partner') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
