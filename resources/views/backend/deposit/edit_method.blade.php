                ...
                <div class="site-card">
                    <div class="site-card-body">
                        <form action="{{ route('admin.deposit.method.update', $method->id) }}" class="row" method="post"
                                    ...
                                    <div class="col-xl-3">
                                        <div class="site-input-groups">
                                            ...
                                            <div class="wrap-custom-file">
                                                <input type="file" name="logo" id="schema-icon"
                                                    accept=".gif, .jpg, .png" />
                                ...
                                <div class="col-xl-6">
                                    <div class="site-input-groups">
                                        ...
                                        <input type="text" class="box-input" name="currency"
                                            value="{{ $method->currency }}" id="currency" />
                                    </div>
                                </div>
                            @endif
                            <div class="col-xl-6">
                            ...
                            <div class="col-xl-6">
                                <div class="site-input-groups">
                                    <label class="box-input-label" for="">{{ __('Minimum Topup:') }}</label>
                                    <div class="input-group joint-input">
                            ...
                            <div class="col-xl-6">
                                <div class="site-input-groups">
                                    <label class="box-input-label" for="">{{ __('Maximum Topup:') }}</label>
                                    <div class="input-group joint-input">
