...
@section('content')
    <div class="main-content">
                ...
                <div class="row">
                    <div class="col">
                        <div class="title-content">
                            <h2 class="title">{{ __('Account Verification') }}</h2>
                                    ...
                                    <tbody>
                                        @foreach ($kycs as $kyc)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($kyc->icon)
                                                        <img src="{{ asset($kyc->icon) }}" alt="kyc icon" width="50">
                                                    @else
                                                        <span>{{ __('N/A') }}</span>
                                                    @endif
                                                </td>
                                                <td><span class="site-badge primary">
                                                        {{ ucfirst($kyc->user_type) }}</span></td>
                                                <td>
                                                    @if ($kyc->status)
        ...
        <div class="modal fade" id="deleteKyc" tabindex="-1" aria-labelledby="deleteKycTypeModalLabel" aria-hidden="true">
