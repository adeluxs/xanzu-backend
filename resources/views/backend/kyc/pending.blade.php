                ...
                <div class="row">
                    <div class="col">
                        <div class="title-content">
                            <h2 class="title">{{ __('Pending Verification') }}</h2>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    @forelse($kycs as $kyc)
                                        <tr>
                                            <td>
                                                @include('backend.kyc.include.__time', [
                                                    'kyc_time' => $kyc->created_at,
                                                ])
                                            </td>
                                            <td>
                                                @include('backend.kyc.include.__user', [
                                                    'id' => $kyc->id,
                                                    'username' => Str::limit($kyc->username, 15),
                                                ])
                                            </td>
                                            <td>
                                                @include('backend.kyc.include.__type', [
                                                    'kyc_type' => $kyc->user_type,
                                                ])
                                            </td>
                                            <td>
                                                @include('backend.kyc.include.__status', [
                                                    'kyc' => $kyc->kyc,
                                                ])
                                            </td>

                                            <td>
                                                @include('backend.kyc.include.__action', [
                                                    'id' => $kyc->id,
                                                ])
                                            </td>
                                        </tr>
...
@section('script')
    <script>
        ...
        let loader =
            '<div class="text-center"><img src="{{ asset('frontend/images/loader.gif') }}" width="100"><h5>{{ __('Please wait') }}...</h5></div>';
