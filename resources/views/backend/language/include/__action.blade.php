...
<a href="{{ route('admin.language.edit', $id) }}" class="round-icon-btn primary-btn" data-bs-toggle="tooltip" title=""
    data-bs-original-title="Edit Language"><i data-lucide="edit-3"></i></a>
