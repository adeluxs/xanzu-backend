                        ...
                        <tbody>
                            @forelse($navigations as $navigation)
                                <tr>
                                    ...
                                    <td>{{ $navigation->page?->url ?? $navigation->url }}</td>
                                    <td><strong
                                            class="site-badge primary">{{ $navigation?->page->title ?? 'Custom Url' }}</strong>
                                    </td>
                                    <td><strong>{{ collect($navigation->type)->map(function ($value) {
                                    ...
                                    <td>
                                        <a class="round-icon-btn blue-btn"
                                            href="{{ route('admin.navigation.translate', $navigation->id) }}">
