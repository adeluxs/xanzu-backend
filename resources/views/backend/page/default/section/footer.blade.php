...
@section('content')
                        ...
                        <div class="site-card">
                            ...
                            <div class="site-card-body">
                                <form action="{{ route('admin.page.section.section.update') }}" method="post"
                                    ...
                                    <div class="site-input-groups row">
                                        <label for="" class="col-sm-3 col-label">{{ __('About Us') }}<i
                                                data-lucide="info" data-bs-toggle="tooltip" title=""
                                                data-bs-original-title="Change the About Us text"></i></label>
                                        <div class="col-sm-9">
                                            <input type="text" name="about_us" class="box-input"
                                                value="{{ $data->about_us }}">
                                        </div>
                                    </div>
                                        ...
                                        <div class="offset-sm-3 col-sm-9">
                                            <div class="paragraph"><i data-lucide="alert-triangle"></i>{{ __('All the') }}
                                                <strong>{{ __('Footer Menus') }}</strong> {{ __('will come from') }} <a
                                                    ...
                                                    class="link">{{ __('Menu Management') }}</a>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <form action="{{ route('admin.social.position.update') }}" method="post">
                        ...
                        <div class="site-card-body">
                            <p class="paragraph"><i data-lucide="alert-triangle"></i>{{ __('All the') }}
                                <strong>{{ __('Social Icons are Draggable.') }}</strong>
                                    ...
                                    <tbody>
                                        @foreach ($socials as $social)
                                            <tr>
                                                ...
                                                <td><strong>{{ $social->url }}</strong></td>
                                                <td>
    ...
    <!-- Modal for Add New  -->
    @include('backend.page.' . site_theme() . '.section.include.__add_new_social')
    <!-- Modal for Add New How It Works End -->

    <!-- Modal for Edit -->
    @include('backend.page.' . site_theme() . '.section.include.__edit_social')
    <!-- Modal for Edit  End-->

    <!-- Modal for Delete  -->
    @include('backend.page.' . site_theme() . '.section.include.__delete_social')
