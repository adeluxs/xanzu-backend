<div class="modal fade" id="addNew" tabindex="-1" aria-labelledby="addNewBenefitModalLabel" aria-hidden="true">
            ...
            <div class="modal-body popup-body">
                ...
                <div class="popup-body-text">
                    ...
                    <form action="{{ route('admin.page.content-store') }}" method="post" enctype="multipart/form-data">
                        ...
                        @if (isset($type) and !in_array($type, ['about-us']))
                            <div class="site-input-groups">
                                ...
                                <div class="text-center">
                                    <code>{{ __('Icon Should be square') }}</code>
                                </div>
                            </div>
                        @endif
