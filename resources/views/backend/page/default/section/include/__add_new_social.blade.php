<div class="modal fade" id="addNew" tabindex="-1" aria-labelledby="addNewHowItWorksModalLabel" aria-hidden="true">
                ...
                <div class="popup-body-text">
                    ...
                    <form action="{{ route('admin.social.store') }}" method="post">
                        ...
                        <div class="site-input-groups">
                            ...
                            <input type="text" name="icon_name" class="box-input mb-0" placeholder="Name"
                                required="" />
                        </div>
