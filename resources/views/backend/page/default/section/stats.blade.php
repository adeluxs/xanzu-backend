...
@section('content')
    <div class="main-content">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-12">
                        <div class="title-content">
                            <h2 class="title">{{ __('Stats Section') }}</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid">
            ...
            <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="{{ $key }}"
                        ...
                        <div class="site-card">
                            <div class="site-card-header">
                                <h3 class="title">{{ __('Background and Activity') }}</h3>
                            </div>
                            <div class="site-card-body">
                                <form action="{{ route('admin.page.section.section.update') }}" method="post"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="section_code" value="stats">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="site-input-groups">
                                                    <div class="switch-field">
                                                        <input type="radio" id="stats-active" name="status"
                                                            @checked($status) value="1" />
                                                        <label for="stats-active">{{ __('Show') }}</label>
                                                        <input type="radio" id="stats-deactivate" name="status"
                                                            @checked(!$status) value="0" />
                                                        <label for="stats-deactivate">{{ __('Hide') }}</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="site-input-groups row">
                                            ...
                                            <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12">
                                                <div class="wrap-custom-file">
                                                    <input type="file" name="background_image" id="statsBackgroundImage"
                                                        accept=".gif, .jpg, .png, .webp" />
                                                    <label for="statsBackgroundImage" id="background_image"
                ...
                <div class="site-card">
                    <div class="site-card-header">
                        <h3 class="title">{{ __('Stats Items') }}</h3>
    ...
    @include('backend.page.' . site_theme() . '.section.include.__add_new_data', ['type' => 'stats'])
