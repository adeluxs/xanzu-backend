...
@section('content')
    <div class="main-content">
        ...
        <div class="container-fluid">
            ...
            <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="site-card">
                            ...
                            <div class="site-card-body">
                                <form action="{{ route('admin.page.section.section.update') }}" method="post"
                                    ...
                                    @csrf
                                    <input type="hidden" name="section_code" value="why-choose-us">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="site-input-groups">
                                                    <div class="switch-field">
                                                        <input type="radio" id="why-active" name="status"
                                                            @checked($status) value="1" />
                                                        <label for="why-active">{{ __('Show') }}</label>
                                                        <input type="radio" id="why-deactivate" name="status"
                                                            @checked(!$status) value="0" />
                                                        <label for="why-deactivate">{{ __('Hide') }}</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="site-card">
                    <div class="site-card-header">
                        <h3 class="title">{{ __('Feature Cards') }}</h3>
    ...
    @include('backend.page.' . site_theme() . '.section.include.__add_new_data', ['type' => 'why-choose-us'])
