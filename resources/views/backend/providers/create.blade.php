                ...
                <div class="row">
                    <div class="col">
                        <div class="title-content">
                            <h2 class="title">{{ __('Create Provider') }}</h2>
                                    ...
                                    <div class="col-xxl-12">
                                        <div class="site-input-groups">
                                            ...
                                            <input type="text" name="name" class="box-input mb-0"
                                                value="{{ old('name') }}"
                                                placeholder="{{ __('e.g. Amazon, eBay, Walmart') }}" required />
                                        </div>
                                    </div>
                                    <div class="col-xxl-6">
                                        <div class="site-input-groups">
                                        ...
                                        <div class="site-input-groups">
                                            ...
                                            <select name="platform" class="form-control form-select">
                                                ...
                                                @foreach (\App\Enums\ProviderPlatform::cases() as $platform)
                                                    <option value="{{ $platform->value }}" @selected(old('platform', \App\Enums\ProviderPlatform::WORDPRESS_WOOCOMMERCE->value) === $platform->value)>
                                            ...
                                            <div class="wrap-custom-file">
                                                ...
                                                <label for="image">
                                                    <img class="upload-icon"
                                                        ...
                                                        alt="">
                                                    <span>{{ __('Select Provider Logo') }}</span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="wrap-custom-file">
                                                ...
                                                <label for="cover_image">
                                                    <img class="upload-icon"
                                                        src="{{ asset('assets/global/materials/upload.svg') }}"
                                                        alt="">
                                                    <span>{{ __('Select Cover Image') }}</span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
