                    ...
                    <div class="site-card-body">
                        <form action="{{ route('admin.settings.update') }}" method="post">
                            ...
                            <div class="site-input-groups">
                                <div class="site-input-groups">
                                    <div class="col-sm-4 col-label pt-0">{{ __('Meta Title') }}</div>
                                    <input name="meta_title" class="box-input" type="text"
                                        value="{{ setting('meta_title', 'meta') }}">
                                </div>
                            </div>
                            <div class="site-input-groups">
                                <div class="site-input-groups">
                            ...
                            <div class="site-input-groups">
                                <div class="site-input-groups">
                                    ...
                                    <input name="meta_keywords" class="box-input" type="text"
                                        value="{{ setting('meta_keywords', 'meta') }}">
                                </div>
                            </div>
