                    ...
                    <div class="site-card overflow-hidden">
                        ...
                        <div class="site-card-body">
                            <div class="support-ticket-single-message user">
                                <div class="logo">
                                    <img class="avatar avatar-round" src="{{ asset($ticket->user->avatar_path) }}"
                            ...
                            @foreach ($ticket->messages as $message)
                                <div
                                    ...
                                    <div class="logo">
                                        @if ($message->model != 'admin')
                                            <img class="avatar avatar-round"
                                                src="{{ asset($ticket->user->avatar_path ?? 'global/materials/user.png') }}"
                                                alt="" height="40" width="40">
                                        @else
                                            <img class="avatar avatar-round"
                                    ...
                                    @php
                                        $ticket_attachments = $message->attachments;
                                    @endphp
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            <div class="wrap-custom-file">
                                                <input type="file" name="attachments[]" id="attach"
                                                    accept=".gif, .jpg, .png" />
                                                <label for="attach">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12 col-md-12">
                                            <div class="site-input-groups">
                                                <textarea class="form-textarea" placeholder="Write Reply" name="message"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="buttons">
