<h3 class="title mb-4">
    {{ __('Payout Approval Action') }}
</h3>

<ul class="list-group mb-4">
    <li class="list-group-item">
        {{ __('Payout Amount') }}: <strong>{{ $data->amount .' '. $currency }}</strong>
    </li>
    <li class="list-group-item">
        {{ __('Payable Amount') }}: <strong>{{ amountWithCurrency($data->pay_amount, $data->pay_currency) }}</strong>
    </li>
    <li class="list-group-item">
        {{ __('Payment Method') }}: <strong>{{ $data->method }}</strong>
    </li>
    <li class="list-group-item">
