                        ...
                        <form action="{{ route('admin.withdraw.method.update', $withdrawMethod->id) }}" class="row"
                                    ...
                                    <div class="col-xl-3">
                                        <div class="site-input-groups">
                                            ...
                                            <div class="wrap-custom-file">
                                                <input type="file" name="icon" id="schema-icon"
                                                    accept=".gif, .jpg, .png" />
                            ...
                            @if ($type == 'manual')
                                <div class="col-xl-6">
                                    <div class="site-input-groups">
                                        ...
                                        <input type="text" class="box-input" name="currency"
                                ...
                                <div class="site-input-groups row">
                                    <div class="col-xl-12">
                                        ...
                                        <div class="input-group joint-input">
                                            <span
                                                class="input-group-text">{{ '1 ' . ' ' . setting('site_currency', 'global') . ' =' }}
                                            </span>
                                        ...
                                        <div class="prcntcurr">
                                            <select name="charge_type" class="form-select">
                                                <option value="percentage"
                                                    @if ($withdrawMethod->charge_type == 'percentage') selected @endif>{{ __('%') }}
                                                </option>
                            ...
                            <div class="col-xl-6">
                                <div class="site-input-groups">
                                    ...
                                    <div class="input-group joint-input">
                                        <input type="text" name="max_withdraw" class="form-control"
                                                ...
                                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="site-input-groups">
                                                        <select name="fields[{{ $key }}][type]"
                                                            ...
                                                            <option value="text"
                                                                @if ($value['type'] == 'text') selected @endif>{{ __('Input Text') }}
                                                            </option>
                                                            ...
                                                            <option value="file"
                                                                @if ($value['type'] == 'file') selected @endif>{{ __('File upload') }}
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
